...
[State 4: 순차 하차 및 개별 복귀 (Sequential Process)]
 ➔ 터틀봇이 멈춰 있는 RC 1호기 앞으로 이동 ➔ 로봇팔 하차 작업 완료 ➔ RC 1호기 '복귀 승인' 신호 수신 후 혼자 단독 복귀 출발.
 ➔ 그동안 RC 2호기는 자기 차례가 아니므로 고정석에서 미동도 없이 Lock 상태 대기 ➔ RC 1 복귀 후 터틀봇이 RC 2 하차 완료 및 복귀 출발.
          ▼
